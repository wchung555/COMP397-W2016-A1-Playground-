...
var scenes;
(function (scenes) {
    var SceneTwoBI = (function (_super) {
        __extends(SceneTwoBI, _super);
        // CONSTRUCTOR ++++++++++++++++++++++
        function SceneTwoBI() {
            _super.call(this);
        }
        // PUBLIC METHODS +++++++++++++++++++++
        // Start Method
        SceneTwoBI.prototype.start = function () {
            // add Intro Image
        ...
        SceneTwoBI.prototype.update = function () {
        };
        //EVENT HANDLERS ++++++++++++++++++++
        // START Button click event handler
        SceneTwoBI.prototype._startOverButtonClick = function (event) {
    ...
    scenes.SceneTwoBI = SceneTwoBI;
})(scenes || (scenes = {}));
//# sourceMappingURL=scenetwobi.js.map